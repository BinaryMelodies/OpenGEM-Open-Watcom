...
#define DEMOOK 2  	/* OBJECT in TREE #1 */
#define DEMOPEND 3  	/* TREE */
#define DEMOPSOK 1  	/* OBJECT in TREE #3 */
#define DEMOCNCL 2  	/* OBJECT in TREE #3 */
#define DEMOOVWR 0  	/* STRING */
#define DEMONWDW 1  	/* STRING */
#define DEMOSVAD 2  	/* TREE */
#define DEMOSOK 1  	/* OBJECT in TREE #2 */
#define DEMOSCNL 2  	/* OBJECT in TREE #2 */
#define DEMONAME 5  	/* OBJECT in TREE #2 */
#define DEMOIMG 7  	/* OBJECT in TREE #1 */
#define DEMOPCLR 9  	/* OBJECT in TREE #3 */
#define DEMOPFIN 19  	/* OBJECT in TREE #3 */
#define DEMOPMED 20  	/* OBJECT in TREE #3 */
#define DEMOPBRD 21  	/* OBJECT in TREE #3 */
#define DEMOEFIN 22  	/* OBJECT in TREE #3 */
